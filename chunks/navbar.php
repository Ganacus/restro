		...
		<nav>
		    <div class="nav-wrapper">
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="admin/index.php" class="hvr-grow">Admin</a></li>

		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +254 712345678. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
